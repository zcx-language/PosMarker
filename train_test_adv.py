...
from data import MARKroot, MARKroot_adv, MARK_512, BaseTransform, preproc, preproc_adv
# from data.data_augment import _mirror, _rotate, _perspect, _noise

from layers.functions import Detect, PriorBox
from layers.modules import MultiBoxLoss, CropMSELoss, CropSSIMLoss
...
save_folder = os.path.join(args.save_folder, args.version + '_' + args.dataset + '_' + str(args.size), args.date + '_fix_gen')
...
visible_criterion = CropSSIMLoss()
